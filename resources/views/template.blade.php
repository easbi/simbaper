...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
        ...
        <nav class="mt-2">
          ...
          <!-- Add icons to the links using the .nav-icon class
           ...
           <!-- <li class="nav-item menu-open"> -->
            ...
            @if(Auth::user()->id == 1 OR Auth::user()->id == 14 OR Auth::user()->id == 17)
            <li class="nav-item has-treeview">
              <a href="{{ url('masterbarang/list')}}" class="nav-link">
                <i class="nav-icon fas fa-table"></i>
                <p>
                  Master Barang
                  <i class="right fas fa-angle-left"></i>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy;2022-2024 <a href="https://padangpanjangkota.bps.go.id">BPS Kota Padang Panjang</a>.</strong>
      All rights reserved.
